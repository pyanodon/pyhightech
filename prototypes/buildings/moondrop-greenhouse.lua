...
for i = 1, 4 do
    local name = "moondrop-greenhouse-mk0" .. i
    local icon = "__pyhightechgraphics__/graphics/icons/moondrop-greenhouse-mk0" .. i .. ".png"
    local icon_size = 64
    ...
    ENTITY {
        ...
        next_upgrade = i ~= 4 and "moondrop-greenhouse-mk0" .. (i + 1) or nil,
        max_health = 100,
        corpse = "big-remnants",
