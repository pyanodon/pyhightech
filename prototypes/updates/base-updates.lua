...
RECIPE('speed-module'):change_category('chip')
RECIPE('speed-module-2'):change_category('chip')
RECIPE("speed-module-3"):replace_ingredient("processing-unit", "intelligent-unit"):replace_ingredient("advanced-circuit", "processing-unit"):change_category('chip')
RECIPE('effectivity-module'):change_category('chip')
RECIPE('effectivity-module-2'):change_category('chip')
RECIPE("effectivity-module-3"):replace_ingredient("processing-unit", "intelligent-unit"):replace_ingredient("advanced-circuit", "processing-unit"):change_category('chip')
RECIPE('productivity-module'):change_category('chip')
RECIPE('productivity-module-2'):change_category('chip')
RECIPE("productivity-module-3"):replace_ingredient("processing-unit", "intelligent-unit"):replace_ingredient("advanced-circuit", "processing-unit"):change_category('chip')
RECIPE('rocket-control-unit'):change_category('chip')
